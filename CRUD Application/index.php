        ...
        <input type="hidden" name="snoEdit" id="snoEdit">
          ...
          <div class="form-floating ">
            <div class="mb-3">
              ...
              <textarea class="form-control" id="descscripationEdit" name="descscripationEdit" style="height: 100px"></textarea>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="/CRUD APPLICATION">Home</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container my-4">
    ...
    <form action="/CRUD APPLICATION/index.php" method="POST">
      ...
      <div class="form-floating ">
        <div class="mb-3">
          <label for="descscripation">Note Descripation</label>
          <textarea class="form-control" id="descscripation" name="descscripation" style="height: 100px"></textarea>
          <label for="floatingTextarea2"></label>
        </div>
      </div>
